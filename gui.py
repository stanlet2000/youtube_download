...
def download_button_click(url_entry, download_path):
    url = url_entry.get()
...
def main():
    ...
    tk.Button(root, text="Download", command=lambda: download_button_click(url_entry, download_path)).pack(pady=20)
